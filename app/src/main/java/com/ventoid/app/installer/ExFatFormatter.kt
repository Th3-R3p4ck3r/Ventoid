...
object ExFatFormatter {
    ...
    fun buildAllocationBitmap(sectorsPerCluster: Int, volumeLayout: VolumeLayout): ByteArray {
        ...
        // Mark every system cluster used, from the FAT-reserved clusters 0/1 up through
        // the bitmap, upcase table and root directory clusters. Failing to mark the root
        // directory cluster (and the tail of the upcase run) as used lets Windows treat
        // those clusters as free and overwrite the root directory when copying an ISO.
